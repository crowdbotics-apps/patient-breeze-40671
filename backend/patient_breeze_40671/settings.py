"""
Django settings for patient_breeze_40671 project.
...
ROOT_URLCONF = 'patient_breeze_40671.urls'
...
WSGI_APPLICATION = 'patient_breeze_40671.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_breeze_40671 API",
    "DESCRIPTION": "API documentation for patient_breeze_40671 App",
    "VERSION": "v1",
}
